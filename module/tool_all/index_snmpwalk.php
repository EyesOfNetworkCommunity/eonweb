...
<h1><?php echo $xmlmodules->getElementsByTagName("snmpwalk")->item(0)->getAttribute("title");?></h1>
...
<form action="./select_tool.php" method="POST" target="right">
	...
	<select id="snmp_version" name="snmp_version" size="1" onchange="changeSnmp();">
  		...
  		<option selected value="2c">version 2c</OPTION>
	...
	<input type=hidden name=tool_list value="../tool_snmpwalk/index.php">
	<input class="button" type="submit" name="run" value='Run it !'> 
</form>

<iframe NORESIZE src="right_frame.php" name="right" frameborder="0" style="position:absolute;top:50px;left:200px;bottom:0px;" height="90%" width="80%">
